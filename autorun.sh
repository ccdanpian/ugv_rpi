...
# Define the cron job for starting the minimal app
cron_job="@reboot XDG_RUNTIME_DIR=/run/user/$(id -u) ~/ugv_rpi/ugv-env/bin/python ~/ugv_rpi/app_minimal.py >> ~/ugv_minimal.log 2>&1"
...
echo "Minimal app autorun setup completed."
